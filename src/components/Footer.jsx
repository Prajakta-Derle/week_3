  ...
  return (
    <div className=" bg-darkBackground text-white">
      <div className=" flex flex-col md:flex-row justify-between p-8 md:mx-32 px-5">
        ...
        <div>
            <h1 className=" font-medium text-xl pb-4 pt-5 md:pt-0">Tours</h1>
            <nav className=" flex flex-col gap-2">
                ...
                <a className=" hover:text-brightColor transition-all cursor-pointer" href="/">Italy, Venice</a>
            </nav>
        </div>
        <div>
      ...
      <div>
        <p className=" text-center py-4">
         <span className=" text-brightColor">Copyright © 2023.</span> | All rights reserved.
        </p>
      </div>
    </div>
  );
